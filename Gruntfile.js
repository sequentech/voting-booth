  ...
  grunt.initConfig({
      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="/booth/libnocompat-v8.0.1.min.js"></script>'},
            ...
            {selector:'body',html:'<script src="/booth/lib-v8.0.1.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentConfig-v8.0.1.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentThemes-v8.0.1.js"></script>'},
            {selector:'body',html:'<script src="/booth/app-v8.0.1.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentPlugins-v8.0.1.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentThemes-v8.0.1.js': ['node_modules/common-ui/dist/SequentThemes-v8.0.1.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/app-v8.0.1.min.js': 'temp/app.js',
          'dist/lib-v8.0.1.min.js': 'temp/lib.js',
          'dist/libnocompat-v8.0.1.min.js': 'temp/libnocompat.js',
