...
var SEQUENT_CONFIG_VERSION = '6.0.1';
  ...
  grunt.initConfig({
      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="/booth/libnocompat-v6.0.1.min.js"></script>'},
            ...
            {selector:'body',html:'<script src="/booth/lib-v6.0.1.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentConfig-v6.0.1.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentThemes-v6.0.1.js"></script>'},
            {selector:'body',html:'<script src="/booth/app-v6.0.1.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentPlugins-v6.0.1.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentConfig-v6.0.1.js': ['SequentConfig.js'],
          'dist/SequentThemes-v6.0.1.js': ['node_modules/common-ui/dist/SequentThemes-v6.0.1.js'],
          'dist/SequentPlugins-v6.0.1.js': ['plugins/**/*.js']
        }
      }
    },
    "merge-json": {
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/app-v6.0.1.min.js': 'temp/app.js',
          'dist/lib-v6.0.1.min.js': 'temp/lib.js',
          'dist/libnocompat-v6.0.1.min.js': 'temp/libnocompat.js',
