  ...
  grunt.initConfig({
      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<!--[if lte IE 8]><script src="/booth/libcompat-v103111.2.min.js"></script><![endif]--><!--[if gte IE 9]><script src="/booth/libnocompat-v103111.2.min.js"></script><![endif]--><!--[if !IE]><!--><script src="/booth/libnocompat-v103111.2.min.js"></script><!--<![endif]-->'},
            ...
            {selector:'body',html:'<script src="/booth/lib-v103111.2.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/avConfig-v103111.2.js"></script>'},
            {selector:'body',html:'<script src="/booth/avThemes-v103111.2.js"></script>'},
            {selector:'body',html:'<script src="/booth/app-v103111.2.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/avPlugins-v103111.2.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/avConfig-v103111.2.js': ['avConfig.js'],
          'dist/avThemes-v103111.2.js': ['bower_components/avCommon/dist/avThemes-v103111.2.js'],
          'dist/avPlugins-v103111.2.js': ['plugins/**/*.js']
        }
      }
    },
    "merge-json": {
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/app-v103111.2.min.js': 'temp/app.js',
          'dist/lib-v103111.2.min.js': 'temp/lib.js',
          'dist/libnocompat-v103111.2.min.js': 'temp/libnocompat.js',
          'dist/libcompat-v103111.2.min.js': 'temp/libcompat.js',
