...
var SEQUENT_CONFIG_VERSION = '7.2.0';
  ...
  grunt.initConfig({
      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="/booth/libnocompat-v7.2.0.min.js"></script>'},
            ...
            {selector:'body',html:'<script src="/booth/lib-v7.2.0.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentConfig-v7.2.0.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentThemes-v7.2.0.js"></script>'},
            {selector:'body',html:'<script src="/booth/app-v7.2.0.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentPlugins-v7.2.0.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentConfig-v7.2.0.js': ['SequentConfig.js'],
          'dist/SequentThemes-v7.2.0.js': ['node_modules/common-ui/dist/SequentThemes-v7.2.0.js'],
          'dist/SequentPlugins-v7.2.0.js': ['plugins/**/*.js']
        }
      }
    },
    "merge-json": {
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/app-v7.2.0.min.js': 'temp/app.js',
          'dist/lib-v7.2.0.min.js': 'temp/lib.js',
          'dist/libnocompat-v7.2.0.min.js': 'temp/libnocompat.js',
