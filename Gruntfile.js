  ...
  grunt.initConfig({
      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="/booth/libnocompat-v5.0.6.min.js"></script>'},
            ...
            {selector:'body',html:'<script src="/booth/lib-v5.0.6.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/avConfig-v5.0.6.js"></script>'},
            {selector:'body',html:'<script src="/booth/avThemes-v5.0.6.js"></script>'},
            {selector:'body',html:'<script src="/booth/app-v5.0.6.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/avPlugins-v5.0.6.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/avConfig-v5.0.6.js': ['avConfig.js'],
          'dist/avThemes-v5.0.6.js': ['node_modules/agora-gui-common/dist/avThemes-v5.0.6.js'],
          'dist/avPlugins-v5.0.6.js': ['plugins/**/*.js']
        }
      }
    },
    "merge-json": {
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/app-v5.0.6.min.js': 'temp/app.js',
          'dist/lib-v5.0.6.min.js': 'temp/lib.js',
          'dist/libnocompat-v5.0.6.min.js': 'temp/libnocompat.js',
