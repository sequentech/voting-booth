...
var SEQUENT_CONFIG_VERSION = '10.5.x';
  ...
  grunt.initConfig({
      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="/booth/libnocompat-v10.5.x.min.js"></script>'},
            ...
            {selector:'body',html:'<script src="/booth/lib-v10.5.x.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentConfig-v10.5.x.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentThemes-v10.5.x.js"></script>'},
            {selector:'body',html:'<script src="/booth/app-v10.5.x.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentPlugins-v10.5.x.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentConfig-v10.5.x.js': ['SequentConfig.js'],
          'dist/SequentThemes-v10.5.x.js': ['node_modules/common-ui/dist/SequentThemes-v10.5.x.js'],
          'dist/SequentPlugins-v10.5.x.js': ['plugins/**/*.js']
        }
      }
    },
    "merge-json": {
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/app-v10.5.x.min.js': 'temp/app.js',
          'dist/lib-v10.5.x.min.js': 'temp/lib.js',
          'dist/libnocompat-v10.5.x.min.js': 'temp/libnocompat.js',
