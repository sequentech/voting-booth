  ...
  grunt.initConfig({
      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="/booth/libnocompat-v4.0.0-beta.1.min.js"></script>'},
            ...
            {selector:'body',html:'<script src="/booth/lib-v4.0.0-beta.1.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/avConfig-v4.0.0-beta.1.js"></script>'},
            {selector:'body',html:'<script src="/booth/avThemes-v4.0.0-beta.1.js"></script>'},
            {selector:'body',html:'<script src="/booth/app-v4.0.0-beta.1.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/avPlugins-v4.0.0-beta.1.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/avThemes-v4.0.0-beta.1.js': ['node_modules/agora-gui-common/dist/avThemes-v4.0.0-beta.1.js'],
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/app-v4.0.0-beta.1.min.js': 'temp/app.js',
          'dist/lib-v4.0.0-beta.1.min.js': 'temp/lib.js',
          'dist/libnocompat-v4.0.0-beta.1.min.js': 'temp/libnocompat.js',
