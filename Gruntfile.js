  ...
  grunt.initConfig({
      ...
      update: {
        options: {
          ...
          append: [
            ...
            {selector:'body',html:'<script src="/booth/libnocompat-v7.1.1.min.js"></script>'},
            ...
            {selector:'body',html:'<script src="/booth/lib-v7.1.1.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentConfig-v7.1.1.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentThemes-v7.1.1.js"></script>'},
            {selector:'body',html:'<script src="/booth/app-v7.1.1.min.js"></script>'},
            {selector:'body',html:'<script src="/booth/SequentPlugins-v7.1.1.js"></script>'},
    ...
    concat: {
      main: {
        files: {
          ...
          'dist/SequentConfig-v7.1.1.js': ['SequentConfig.js'],
          'dist/SequentThemes-v7.1.1.js': ['node_modules/common-ui/dist/SequentThemes-v7.1.1.js'],
          'dist/SequentPlugins-v7.1.1.js': ['plugins/**/*.js']
        }
      }
    },
    "merge-json": {
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/app-v7.1.1.min.js': 'temp/app.js',
          'dist/lib-v7.1.1.min.js': 'temp/lib.js',
          'dist/libnocompat-v7.1.1.min.js': 'temp/libnocompat.js',
